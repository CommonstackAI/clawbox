...
import { ONBOARD_STATE_FILE, CLAWBOX_DIR } from './constants'
...
/**
 * Read the onboard state from ~/.clawbox/onboard-state.json
 */
...
/**
 * Write the onboard state to ~/.clawbox/onboard-state.json
 */
 ...
 * 1. Onboard state file exists in ~/.clawbox
