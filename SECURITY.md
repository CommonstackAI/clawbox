...
- ClawBox reads local runtime state from `~/.clawbox` and may connect to OpenClaw data in `~/.openclaw`; neither directory belongs in bug reports unless fully redacted.
