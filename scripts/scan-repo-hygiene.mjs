...
const scanners = {
  public: [
    ...
    { name: 'legacy-brand-previous-name', regex: new RegExp(`${'Wrapper'}${'Box'}`, 'g') },
    { name: 'legacy-home-previous-name', regex: new RegExp(`\\.${'wrapper'}${'box'}\\b`, 'g') },
    { name: 'legacy-manifest-previous-name', regex: new RegExp(`${'wrapper'}${'box'}-${'runtime'}.json`, 'g') },
    { name: 'legacy-repo-previous-origin', regex: new RegExp(`${'FantWu2024'}/${'Wrapper'}${'Box'}`, 'g') },
  ],
  secrets: [
